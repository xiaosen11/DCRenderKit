...
Session D：#66 PortraitBlur mask routing integration tests（`Tests/DCRenderKitTests/IntegrationTests/`，3 tests synthetic-source / half-split-mask 覆盖 Demo→SDK 路径） · #70 Maintainer SOP + SECURITY.md（`docs/maintainer-sop.md` PR review / release cut / breaking-change 登记 checklist + `SECURITY.md` 漏洞报告 scope / 支持版本 / 响应 SLA）。
...
### Session C 保留做（Session D 推进中）

| ID | 任务 | 落在哪 |
|---|---|---|
| #69 | GitHub Discussions 指南（页面开启由你做） | `docs/discussions-guide.md` |

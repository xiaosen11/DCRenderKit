...
- **重要说明**: 这些常数**写在 shader 里时未标注为 Zone 中点**，导致长期被误认为 Harbeth empirical magic number。B.4 发现后**追认**为 Zone System derivation。Harbeth 作者是否有意为之不可考，但数值匹配精确到 <0.005 超越巧合范围
